...
import * as parkData from "../../data/violenceTrauma.json"
...
export default function App() {
    return (
        ...
        <div className="">
                            ...
                            <div class="card">
                            <div class="card-body">
                            <h1 class=" text-center display-4">Violence Trauma Support</h1>
                        ...
                        All Services
                         ...
                         <a class="dropdown-item" href="/eatingDisordersSupportMap">Eatin Disorders Support</a>
